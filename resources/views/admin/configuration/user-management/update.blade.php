...
<div class="col-xl-12">
    ...
    <div class="card card-flush h-lg-100" id="kt_contacts_main">
        ...
        <div class="card-body pt-5">
            <!--begin::Form-->
            <form id="kt_ecommerce_settings_general_form" class="form" action="{{ route('user-management.update',$user->id) }}" method="POST">
                @csrf
                @method('PUT')
                            ...
                            <div class="form-floating border rounded">
                                ...
                                <select class="form-select form-select-solid lh-1 py-3 @error('role') is-invalid @enderror"
                                    ...
                                    id="inputRole">
                                        ...
                                        <option value="super_admin" {{$user->preferences->role == 'super_admin' ? 'selected="selected"' : ''}}>Super Admin</option>
                                        <option value="admin" {{$user->preferences->role == 'admin' ? 'selected="selected"' : ''}}>Admin</option>
                                        <option value="operator" {{$user->preferences->role == 'operator' ? 'selected="selected"' : ''}}>Operator</option>
                                </select>
                                <!--end::Select2-->
                            </div>
                        </div>
